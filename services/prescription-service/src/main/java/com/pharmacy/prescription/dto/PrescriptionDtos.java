...
public class PrescriptionDtos {
  ...
  public record PharmacyView(String id, String name, String address, String phone) {}
  public record CreateDoctorProfileRequest(@NotBlank String firstName,@NotBlank String lastName,@NotBlank @Email String email,@NotBlank String licenseNumber,String phone) {}
  public record UpdateDoctorProfileRequest(@NotBlank String firstName,@NotBlank String lastName,String phone) {}
}
