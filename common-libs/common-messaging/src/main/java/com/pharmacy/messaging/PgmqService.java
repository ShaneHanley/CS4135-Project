...
public class PgmqService {
    ...
    public PgmqService(JdbcTemplate jdbcTemplate, ObjectMapper objectMapper) {
    ...
    public boolean archiveMessage(String queue, long id) {
        Boolean archived = jdbcTemplate.queryForObject("SELECT pgmq.archive(?::text, ?)", Boolean.class, queue, id);
